...
@section('title', 'Direccion de facturación')

@section('content')

<div class="page-section title-area skyblue">
  <h1>Direcci&oacute;n de Facturaci&oacute;n</h1>
</div>
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3 white-bg"> 
                ...
                <form method="post">
                    ...
                    <input name="direccion1" class="form-control" value="{{ $b_address->street_address1 or old('direccion1', '') }}" placeholder="Ej. Calle de la Paz #100" type="text">
                    
                    <label >Direccion 2 :</label>
                    <input name="direccion2" class="form-control" value="{{ $b_address->street_address2 or old('direccion2', '') }}" placeholder="Ej. Las Puentes 3er Sector" type="text">
                    ...
                    <label>Estado * :</label>
                        ...
                        <input name="municipio" class="form-control billing-address-city"  placeholder="Ej. Monterrey, Apodaca, etc." value="{{ $b_address->city or old('municipio', '') }}" type="text">
                    ...
                    <input name="codigoPostal" class="form-control" value="{{ $b_address->postal_code or old('codigoPostal', '') }}" placeholder="22330" type="text">
                  
                    
                    <label >Indicaciones :</label>
                    <input name="indicaciones" class="form-control" value="{{ $b_address->indications or old('indicaciones', '') }}" placeholder="Casa naranja de dos pisos" type="text">
...
(function(yourcode) {
    ...
    billingAddressState.val('{{ $b_address->state or "" }}');
    selectBillingCity.val('{{ $b_address->city or ""}}');
